...
public class EditTextDialogFragment extends DialogFragment {
    ...
    /**
     * Create a new instance of a {@link EditTextDialogFragment}
     *
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mEditText = (EditText) view.findViewById(R.id.fragment_dialog_edit_text);
        mEditText.setHint(editTextHint);
        mEditText.setText(editTextInitialText);
        mNopeAnimator = Util.nopeAnimation(mEditText, mEditText.getPaddingLeft());
